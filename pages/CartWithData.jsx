    ...
    <SafeAreaView>
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.containerView} showsVerticalScrollIndicator={false}>
        {
          produk.map((produk) => {
            return (
              <CardCart image={produk.image} key={produk.id} nama={produk.title} kategori={produk.category} harga={produk.price} desc={produk.description}/>
            )
          })
        }
        </ScrollView>
